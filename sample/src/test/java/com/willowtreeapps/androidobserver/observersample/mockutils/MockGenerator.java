package com.willowtreeapps.androidobserver.observersample.mockutils;
...
import com.willowtreeapps.androidobservables.ActivityObserver;
...
public class MockGenerator {
    ...
    public static ObservableActivity getMockActivity(ActivityObserver observer) {
        //Loop through the fields of the observer and set up the views so that they can be found through activity.findViewByID();
        ObservableActivity activity = mock(ObservableActivity.class);
